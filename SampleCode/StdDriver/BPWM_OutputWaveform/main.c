...
int32_t main(void)
{
    ...
    printf("    waveform output pin: BPWM0_CH0(PA.0), BPWM0_CH1(PA.1), BPWM0_CH2(PA.2), BPWM0_CH3(PA.3), BPWM0_CH4(PF.5), BPWM0_CH5(PF.4)\n");
		...
		//BPWM_ENABLE_COMPLEMENTARY_MODE(BPWM0);
    /* BPWM0 channel 0~5 frequency and duty configuration are as follows */
    BPWM_ConfigOutputChannel(BPWM0, 0, 60000, 10);//The pwm is 60k/2
    BPWM_ConfigOutputChannel(BPWM0, 1, 60000, 20);
    BPWM_ConfigOutputChannel(BPWM0, 2, 60000, 30);
    BPWM_ConfigOutputChannel(BPWM0, 3, 60000, 40);
    BPWM_ConfigOutputChannel(BPWM0, 4, 60000, 50);
    BPWM_ConfigOutputChannel(BPWM0, 5, 60000, 60);
    ...
    BPWM_EnableLoadMode(BPWM0, 1, BPWM_LOAD_MODE_CENTER);
		...
		BPWM_SET_ALIGNED_TYPE(BPWM0,0,BPWM_UP_DOWN_COUNTER);			
		BPWM_SET_ALIGNED_TYPE(BPWM0,1,BPWM_UP_DOWN_COUNTER);
		BPWM_SET_ALIGNED_TYPE(BPWM0,2,BPWM_UP_DOWN_COUNTER);
		BPWM_SET_ALIGNED_TYPE(BPWM0,3,BPWM_UP_DOWN_COUNTER);
		BPWM_SET_ALIGNED_TYPE(BPWM0,4,BPWM_UP_DOWN_COUNTER);
		BPWM_SET_ALIGNED_TYPE(BPWM0,5,BPWM_UP_DOWN_COUNTER);
		BPWM0->WGCTL0=0;
		BPWM0->WGCTL1=0X0AAA0555;
		//BPWM0->WGCTL1=0X05550AAA;
