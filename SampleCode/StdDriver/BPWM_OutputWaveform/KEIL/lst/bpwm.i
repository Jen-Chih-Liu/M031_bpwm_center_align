...
#line 12 "..\\..\\..\\..\\Library\\StdDriver\\src\\bpwm.c"
...
uint32_t BPWM_ConfigCaptureChannel(BPWM_T *bpwm, uint32_t u32ChannelNum, uint32_t u32UnitTimeNsec, uint32_t u32CaptureEdge)
{
    ...
    if (bpwm == ((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))
    {
        u32Src = ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x1ul << (8));
    }
    else      
    {
        u32Src = ((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x1ul << (9));
    }
...
uint32_t BPWM_GetCaptureIntFlag(BPWM_T *bpwm, uint32_t u32ChannelNum)
{
    return (((((bpwm)->CAPIF & ((0x1ul << (8)) << u32ChannelNum)) ? 1UL : 0UL) << 1UL) |             (((bpwm)->CAPIF & ((0x1ul << (0)) << u32ChannelNum)) ? 1UL : 0UL));
