...
#line 223 "..\\..\\..\\..\\Library\\StdDriver\\inc\\adc.h"
...
#line 257 "..\\..\\..\\..\\Library\\StdDriver\\inc\\adc.h"
...
#line 115 "..\\..\\..\\..\\Library\\StdDriver\\inc\\fmc.h"
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((((2) & 0x03UL) << 30)|((((18)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((8)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)));
    ...
    CLK_SetModuleClock(((((2) & 0x03UL) << 30)|((((18)) & 0x1fUL) << 0)| (((2) & 0x03UL) << 28)|(((1) & 0x07UL) << 25)|((((8)) & 0x1fUL) << 20)| (((0x0) & 0x03UL) << 18)|(((0x0) & 0xffUL) << 10)|(((0x0) & 0x1fUL) << 5)), (0x1UL<<(8)), 0);
    ...
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL & (~(0xful << (0)))) | (0x0CUL<<(0));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL & (~(0xful << (4)))) | (0x0CUL<<(4));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL & (~(0xful << (8)))) | (0x0CUL<<(8));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPA_MFPL & (~(0xful << (12)))) | (0x0CUL<<(12));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPF_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPF_MFPL & (~(0xful << (20)))) | (0x08UL<<(20));
    ((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPF_MFPL = (((SYS_T *) ((( uint32_t)0x40000000) + 0x00000))->GPF_MFPL & (~(0xful << (16)))) | (0x08UL<<(16));
}
...
int32_t main(void)
{
    ...
    printf("\n\nCPU @ %dHz\n", SystemCoreClock);
    printf("BPWM0 clock is from %s\n", (((CLK_T *) ((( uint32_t)0x40000000) + 0x00200))->CLKSEL2 & (0x1ul << (8))) ? "PCLK" : "PLL");
    printf("+------------------------------------------------------------------------+\n");
    ...
    BPWM_ConfigOutputChannel(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 0, 60000, 10);
    BPWM_ConfigOutputChannel(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 1, 60000, 20);
    BPWM_ConfigOutputChannel(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 2, 60000, 30);
    BPWM_ConfigOutputChannel(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 3, 60000, 40);
    BPWM_ConfigOutputChannel(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 4, 60000, 50);
    BPWM_ConfigOutputChannel(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 5, 60000, 60);
		BPWM_EnableLoadMode(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 0, ((0x1ul << (0))));
    BPWM_EnableLoadMode(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 1, ((0x1ul << (0))));
		BPWM_EnableLoadMode(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 2, ((0x1ul << (0))));
		BPWM_EnableLoadMode(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 3, ((0x1ul << (0))));
		BPWM_EnableLoadMode(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 4, ((0x1ul << (0))));
		BPWM_EnableLoadMode(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 5, ((0x1ul << (0))));
		((((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))->CTL1 = ((2UL)));			
		((((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))->CTL1 = ((2UL)));
		((((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))->CTL1 = ((2UL)));
		((((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))->CTL1 = ((2UL)));
		((((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))->CTL1 = ((2UL)));
		((((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)))->CTL1 = ((2UL)));
		((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000))->WGCTL0=0;
		((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000))->WGCTL1=0X0AAA0555;
		
		
     
    BPWM_EnableOutput(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 0x3F);

     
    BPWM_Start(((BPWM_T *) ((( uint32_t)0x40000000) + 0x5A000)), 0x3F);
